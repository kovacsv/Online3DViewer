...
import { ColorToMaterialConverter, NameFromLine, ParametersFromLine, ReadLines, IsPowerOfTwo, NextPowerOfTwo, UpdateMaterialTransparency, SetOcctImportJsBaseUrl, GetOcctImportJsBaseUrl, CreateOcctWorker, LoadExternalLibrary } from './import/importerutils.js';
...
export {
    ...
    SetOcctImportJsBaseUrl,
    GetOcctImportJsBaseUrl,
    CreateOcctWorker,
    LoadExternalLibrary,
    BinaryReader,
    BinaryWriter,
