...
class SettingsModelDisplaySection extends SettingsSection {
  constructor(parentDiv, settings) {
    super(parentDiv, findName('ModelDisplay'), settings);
  ...
  Init(callbacks) {
    ...
    AddDiv(backgroundColorDiv, null, findName('BackgroundColor'));
    ...
    AddDiv(this.environmentMapPhongDiv, null, findName('BackgroundImage'));
    ...
    AddDiv(this.environmentMapPbrDiv, null, findName('Environment'));
    ...
    AddDiv(edgeColorRow, null, findName('EdgeColor'));
    ...
    this.thresholdSlider.setAttribute('title', findName('EdgeAngleThreshold'));
...
class SettingsImportParametersSection extends SettingsSection {
  constructor(parentDiv, settings) {
    super(parentDiv, findName('ImportSettings'), settings);
  ...
  Init(callbacks) {
    ...
    AddDiv(defaultColorDiv, null, findName('DefaultColor'));
