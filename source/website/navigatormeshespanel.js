...
export class NavigatorMeshesPanel extends NavigatorPanel {
  ...
  FillButtons(importResult) {
    ...
    this.buttons = {
      flatList: {
        name: findName('FlatList'),
        icon: 'flat_list',
        div: null,
        iconDiv: null,
      },
      treeView: {
        name: findName('TreeView'),
        icon: 'tree_view',
        div: null,
        iconDiv: null,
      },
      separator: null,
      expandAll: {
        name: findName('ExpandAll'),
        icon: 'expand',
        div: null,
        iconDiv: null,
      },
      collapseAll: {
        name: findName('CollapseAll'),
        icon: 'collapse',
        div: null,
        iconDiv: null,
      },
      showHideMeshes: {
        name: findName('SHMeshes'),
        icon: 'visible',
        div: null,
        iconDiv: null,
      },
      fitToWindow: {
        name: findName('FitMeshesToWindow'),
        icon: 'fit',
        div: null,
        iconDiv: null,
      },
