...
export class NavigatorMeshesPanel extends NavigatorPanel
{
    ...
    FillMeshTree (model)
    {
        function AddMeshToNodeTree (panel, node, mesh, meshIndex, parentItem, mode)
        {
            ...
            // Get mesh name from the mesh itself, not from the node, because when meshes are generated by the viewer they may not be attached to the original node. This happens in the case of nested assemblies.
