...
export function ShowSnapshotDialog(viewer) {
  ...
  let contentDiv = dialog.Init(findName('CreateSnapshot'), [
    {
  ...
  let transparentCheckbox = AddCheckbox(
    optionsDiv,
    'snapshot_transparent_background',
    findName('TransparentBackground'),
    isTransparent,
    () => {
